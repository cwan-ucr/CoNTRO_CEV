...
def test_PPO_agent(constants, device, loaded_model):
    ...
    local_NN = NN_Model(s_a['s'], s_a['a'], constants['ppo']['hidden_layer_size'], constants['ppo']['actor_layer_size'], constants['ppo']['critic_layer_size'], device).to(device)
...
if __name__ == '__main__':
    ...
    run(load_model_file='normal_3.pt')
